...
// ClickHouse native protocol constants. Keep feature gates aligned with:
// https://raw.githubusercontent.com/ClickHouse/ClickHouse/master/src/Core/ProtocolDefines.h
//
// DBMS_TCP_PROTOCOL_VERSION is intentionally capped at 54479 (ClickHouse 25.8
// protocol) until this client implements and tests later wire fields. Current
// ClickHouse master may define a higher value.
...
/** Protocol version for parallel replicas feature negotiation at protocol revision 54479. */
export const DBMS_PARALLEL_REPLICAS_PROTOCOL_VERSION = 5;
...
export function assertNotChunkedCompatible(serverSend: string, serverRecv: string): void {
  if (serverSend === "chunked") {
    throw new Error(
      `Server requires chunked protocol (send=chunked); this client only supports notchunked`,
    );
  }
  if (serverRecv === "chunked") {
    throw new Error(
      `Server requires chunked protocol (recv=chunked); this client only supports notchunked`,
    );
  }
}
...
/**
 * Native protocol feature gates from ClickHouse's ProtocolDefines.h.
 * Keep values/names aligned with upstream when bumping DBMS_TCP_PROTOCOL_VERSION.
 * Source: https://raw.githubusercontent.com/ClickHouse/ClickHouse/master/src/Core/ProtocolDefines.h
 */
export const REVISIONS = {
  ...
  DBMS_MIN_PROTOCOL_VERSION_WITH_INITIAL_QUERY_START_TIME: 54449n,
  ...
  DBMS_MIN_PROTOCOL_VERSION_WITH_SERVER_QUERY_TIME_IN_PROGRESS: 54460n,
  DBMS_MIN_PROTOCOL_VERSION_WITH_PASSWORD_COMPLEXITY_RULES: 54461n,
  DBMS_MIN_REVISION_WITH_INTERSERVER_SECRET_V2: 54462n,
  DBMS_MIN_PROTOCOL_VERSION_WITH_TOTAL_BYTES_IN_PROGRESS: 54463n,
  DBMS_MIN_REVISION_WITH_SETTINGS_SERIALIZED_AS_STRINGS: 54429n,
  ...
  DBMS_MIN_REVISION_WITH_SERVER_SETTINGS: 54474n,
  DBMS_MIN_REVISION_WITH_QUERY_AND_LINE_NUMBERS: 54475n,
  // Upstream misspells "REVISION" as "REVISON" in this constant name.
  DBMS_MIN_REVISON_WITH_JWT_IN_INTERSERVER: 54476n,
  DBMS_MIN_REVISION_WITH_QUERY_PLAN_SERIALIZATION: 54477n,
  DBMS_MIN_REVISION_WITH_VERSIONED_CLUSTER_FUNCTION_PROTOCOL: 54479n,
};
